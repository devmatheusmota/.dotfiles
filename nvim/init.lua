...
require('lazy').setup({
  ...
  -- disable copilot for golang files but not for other languages
  {
    'github/copilot.vim',
    config = function()
  ...
  },
  {
    ...
    build = ':TSUpdate',
    dependencies = {
      -- Treesitter is a parser generator that provides syntax highlighting, code folding, and more.
      -- It is used by many plugins to provide better syntax highlighting and code folding.
      'nvim-treesitter/nvim-treesitter-textobjects',
      'nvim-treesitter/playground', -- Playground for treesitter
      'JoosepAlviste/nvim-ts-context-commentstring', -- Context aware comment string
    },
    opts = {
      ensure_installed = { 'c', 'cpp', 'lua', 'python', 'javascript', 'typescript', 'html', 'css', 'json', 'yaml', 'bash', 'go' },
    },
  },
